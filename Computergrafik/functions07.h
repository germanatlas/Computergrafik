#ifndef FUNCTIONS07_H
#define FUNCTIONS07_H
...
void mouse_callback(GLFWwindow* window, double currentX, double currentY) {
    ...
    std::cout << "X: " << offsetX << "\tY: " << offsetY << "\n";
    lastX = currentX;
    lastY = currentY;
    yaw += offsetX * 0.1f;
    pitch -= offsetY * 0.1f; // it's first person, so I'll invert the vertical input
...
void setMVP(Shader ourShader, glm::vec3 pos) {
    ...
    view = GetViewMatrix();//glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f));
